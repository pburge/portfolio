	...
	<div class='large-12 columns'>
		<section>
			<header id="header" class="major">
				<h3>My Left Ear</h3>
				<h4>Site is dead, but most code is viewable on <a target="_blank" href="https://github.com/pburge/MyLeftEar">GitHub</a></h4>
		...
		<div class="row">
			...
			<div class="large-6 medium-6 small-6 columns">
				<ul class="inline-list right">
					<li><a target="_blank" href="https://www.linkedin.com/pub/paul-burge/78/579/7b9">LinkedIn</a></li>
					<li><a target="_blank" href="https://github.com/pburge">GitHub</a></li>
				</ul>
			</div>
		</div>
	</div>
